/// The analysis prompts, verbatim ports from config.py (docs/APP_PORT_SPEC.md §1).
///
/// FOOD_DETECTION_PROMPT is sent with every photo; textHandlerPrompt() fills
/// the five placeholders the Python .format call fills. Do not "improve" the
/// wording here — the server and the app must stay behaviorally identical,
/// and every rule below is pinned by production behavior.
library;
